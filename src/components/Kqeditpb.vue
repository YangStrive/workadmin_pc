  ...
  methods: {
        ...
        success: (res) => {
          ...
          if (res && res.errno == 0) {
            ...
            if (!res.data.length) {
              ...
              const b = [...banci, ...banci, ...banci];
              this.all_list.forEach((obj, index) => {
                this.all_list[0].date_schedule.forEach((obj1, index1) => {
    ...
    changeBcAddr() {
      ...
      if (this.sel_bc_addr.isAllDay == 1) {
        ...
        this.all_list[this.sel_bc_addr.data_coordinate[0]].date_schedule[
    ...
    handleCurrentChange() {
      ...
      this.pb_list = this.all_list.slice(
...
.kqeditpb
  ...
  .kqpb_sel
  .sel_item
  .el-button--default.select_member
  span {
  font-size: 14px;
  color: #1f2d3d;
}
.kqeditpb
  ...
  .kqpb_sel
  .sel_item
  .el-button--default.select_member:hover {
...
.kqeditpb
  ...
  .kqpb_sel
  .sel_item
  .el-button--default.select_member:active,
.kqeditpb
  .kqeditpb_main
  .kqpb_sel
  .sel_item
  .el-button--default.select_member:focus {
...
.kqeditpb
  ...
  th
  + th.disabled_style:after,
.kqeditpb
  .kqeditpb_main
  .pb_edit_table
  .el-table__body-wrapper
  td.disabled_style:first-child:after {
  content: "";
...
.kqeditpb .colorblock_item_A,
.colorblock_item_AA {
  background-color: #83aef2;
}
.kqeditpb .colorblock_item_B,
.colorblock_item_BB {
  background-color: #fea560;
}
.kqeditpb .colorblock_item_C,
.colorblock_item_CC {
  background-color: #8bd574;
}
.kqeditpb .colorblock_item_D,
.colorblock_item_DD {
  background-color: #fa876d;
}
