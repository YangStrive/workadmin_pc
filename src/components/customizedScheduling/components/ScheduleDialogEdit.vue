      ...
      try {
        ...
        { 
          ...
          data: {
            ...
            group_ids: '',
            user_ids: this.editInfo.user_ids,
          }
        });
                  ...
                  this.temporarySchedule.workTimetList = [
                    {
                      ...
                      end_time: new Date(2024,8,1, schedule[0].end_time.split(':')[0], schedule[0].end_time.split(':')[1]),
                    }
                  ]
                }else{
                  let workTimetList = [];
                  schedule.forEach((item2) => {
                    workTimetList.push({
                      start_time: new Date(2024,8,1, item2.start_time.split(':')[0], item2.start_time.split(':')[1]),
                      end_time: new Date(2024,8,1, item2.end_time.split(':')[0], item2.end_time.split(':')[1]),
                    })
                  })
